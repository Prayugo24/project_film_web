...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
  ...
  <link rel="stylesheet" href=<?php echo base_url("assets/css/contactstyle.css");?> type="text/css" media="all" />
  <!-- news-css -->
  <link rel="stylesheet" href=<?php echo base_url("assets/news-css/news.css");?> type="text/css" media="all" />
  <link rel="stylesheet" href=<?php echo base_url("assets/list-css/list.css");?> type="text/css" media="all" />
  <!-- //banner-slider -->
  <!-- pop-up -->
  ...
  <!-- //font-awesome icons -->
  <!-- js -->
  <script type="text/javascript" src=<?php echo base_url( "assets/js/jquery-2.1.4.min.js");?>
    >
  </script>
  <!-- //js -->
  ...
  <script type="text/javascript" src=<?php echo base_url("assets/js/easing.js");?>
    >
  </script>
